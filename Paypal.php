    			...
    			<form action="<?php echo $paypalUrl; ?>" method="post" name="frmPayPal1">
					<div class="panel price panel-red">
						...
						<div class="panel-body text-center">
							<p class="lead" style="font-size:40px"><strong><?PHP echo "RS ". $_SESSION['tot']?></strong></p>
						</div>
						<ul class="list-group list-group-flush text-center">
							<li class="list-group-item"><i class="icon-ok text-danger"></i> GROCERY SHOPPY</li>
							<li class="list-group-item"><i class="icon-ok text-danger"></i> ONLINE PAYMENT</li>
							<li class="list-group-item"><i class="icon-ok text-danger"></i> 27/7 support</li>
						</ul>
						<div class="panel-footer">
							<button class="btn btn-lg btn-block btn-danger" href="success.php">PAY NOW</button>
						</div>
					</div>
    			</form>
			<!-- /PRICE ITEM -->
